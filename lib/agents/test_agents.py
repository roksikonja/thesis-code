...
class AgentMixedTest(BaseAgent):
    def __init__(self, case, action_set, reward_class=RewardL2RPN2019, **kwargs):
        BaseAgent.__init__(self, name="Mixed agent", case=case)
...
class AgentGreedy(BaseAgent):
    def __init__(self, case, action_set):
        BaseAgent.__init__(self, name="Greedy agent", case=case)
...
class AgentMixedMultistepTest(BaseAgent):
    def __init__(self, case, action_set, reward_class=RewardL2RPN2019, **kwargs):
        BaseAgent.__init__(self, name="Mixed Multistep agent", case=case)
